/*
 * Compilação: mpicc -o implementacao-dos-snaphots-de-chandy-lamport implementacao-dos-snaphots-de-chandy-lamport.c
 * Execução:   mpiexec -n 3 ./implementacao-dos-snaphots-de-chandy-lamport
 * ## Integrantes
...
// VERSÃO 1 (RELÓGIOS SAINDO NA ORDEM ERRADA)
